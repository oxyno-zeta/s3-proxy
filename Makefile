...
ifndef HAS_FIELDALIGNMENT
	...
	$(GO) install golang.org/x/tools/go/analysis/passes/fieldalignment/cmd/fieldalignment@v0.50.0
endif
ifndef HAS_GOVERTER
	@echo "=> Installing goverter tool"
	$(GO) install github.com/jmattheis/goverter/cmd/goverter@v1.10.0
endif
	go mod download all
	go mod tidy
